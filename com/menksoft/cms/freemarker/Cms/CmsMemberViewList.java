 ...
 * @author 呼和
 */
public class CmsMemberViewList implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		if(params.get(PARAM_num)==null)
			throw new TemplateModelException("dbh_member_viewlist"+"缺少参数"+PARAM_num);
			...
			try {
				...
				member.setId(id);
				PagingTools<ViewRecords>list=viewRecordsService.getViewRecords(id,datanum,currentPage-1);
				...
				for(ViewRecords viewRecords:list.getDataSet()){
					env.setVariable(params.get("var").toString(), DEFAULT_WRAPPER.wrap(viewRecords));
