 ...
 * @author 呼和
 */
public class CmsMemberConsumeList implements TemplateDirectiveModel {
	private static final String PARAM_num = "count";
	/* (non-Javadoc)
	 * @see freemarker.template.TemplateDirectiveModel#execute(freemarker.core.Environment, java.util.Map, freemarker.template.TemplateModel[], freemarker.template.TemplateDirectiveBody)
	 */
	@Resource
	MemberDownService memberDownService;
	@Override
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		if(params.get(PARAM_num)==null)
			throw new TemplateModelException("dbh_member_consumelist"+"缺少参数"+PARAM_num);
			...
			try {
				PagingTools<MemberDown>list=memberDownService.getMemberDownForpage(id, currentPage-1, datanum);
				...
				for(MemberDown memberDown:list.getDataSet()){
					env.setVariable(params.get("var").toString(), DEFAULT_WRAPPER.wrap(memberDown));
