...
public class UploadFileServlet extends HttpServlet {
	...
	private static String fileExt = "jpg,jpeg,bmp,gif,png,zip,rar,mp4,3gp,mp3";
	...
	public void init() throws ServletException {
		...
		if (StringUtils.isBlank(fileExt)) fileExt = "jpg,jpeg,bmp,gif,png,zip,rar,mp4,3gp,mp3";
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			/*检查文件类型*/
			System.out.println("=sss=="+ fileExt.toLowerCase() );
			...
			newFileName ="http://" + request.getServerName() + ":"
		                + request.getServerPort() + request.getContextPath() + saveDirPath + filename + "." + extensionName;		
