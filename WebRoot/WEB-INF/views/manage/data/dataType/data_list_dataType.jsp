...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//打开更新窗口，编码表	
			...
			function save(){
				...
				var id = $('#id').val();
				if(id=='0'){
					url ="${basePath}action/manage/data/dataType/save";
				
				}else{
					url ="${basePath}action/manage/data/dataType/update";
			...
			//删除编码数据
             ...
             $.messager.confirm('Confirm','数据删除不可恢复，确认删除吗？',function(r){
	            ...
	            var id = String(ids);
	             $.ajax({
				   type:'GET',
				   url:"${basePath}action/manage/data/dataType/delete/"+id,
		...
		function delall(){
			$.messager.confirm('Confirm','数据删除不可恢复，确认删除吗？',function(r){
				if (r){
					...
					var url="${basePath}action/manage/data/dataType/delete/"+ids;
	...
	<div id="win" class="easyui-window" title="码表信息" style="width:400px;height:200px;" data-options="iconCls:'icon-save',modal:true,shadow:true,closed:true,collapsible:false,minimizable:false">
