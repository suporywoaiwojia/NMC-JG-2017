...
<div class="easyui-panel" title="项目信息" style="width:100%;padding:20px 30px;">
  ...
  <div style="margin:10px 0">
    <form id="web_form" action="" method="post">
       ...
       <input type="hidden" id="filesUploadPath" name="filesUploadPath" />
       <input type="hidden" id="filesHttpPath" name="filesHttpPath" />
	<table align="center" >
        <tr>
        <td >姓名:</td>
        <td><input id="name"  name="name" data-options="required:true,validType:'length[0,50]',missingMessage:'姓名不能为空',invalidMessage:'长度不能超出50个字符'" class="easyui-textbox" style="text-align:center;width:300px;height:30px" /></td>        
        <td style="padding-left:40px;">性别:</td>
        <td><input id="sex" name="sex" data-options="required:true,validType:'length[0,10]',missingMessage:'性别不能为空',invalidMessage:'作者长度不能超出20个字符'" class="easyui-textbox" style="width:300px;height:30px;text-align:center;" /></td>        
