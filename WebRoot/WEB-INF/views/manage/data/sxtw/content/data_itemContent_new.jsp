...
<html xmlns="http://www.w3.org/1999/xhtml">
		  ...
		  <form method="post" id="web_form">
			...
			<table class="data "  >
			  <tr>
				...
				<td><input class="easyui-textbox" style="text-align:center;width:300px;height:30px" name="page" id="page"  data-options="required:false,validType:'length[0,500]',invalidMessage:'长度不能超出500个字符',multiline:true">
                </td>
	...
	<script type="text/javascript">
		function save(){
			var url = "${basePath}action/manage/data/itemContent/save";
