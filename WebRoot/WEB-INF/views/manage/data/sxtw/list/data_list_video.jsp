...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
       ...
       function loadCatalogPage(itemId){
			window.parent.topage('内容列表','manage/data/item/itemContent/'+itemId+'/0/10');
		}
		//弹出的的提示信息,刷新页面
	...
	<body>
		...
		<thead>
			<tr>
				...
				<th data-options="field:'country',width:'10%',align:'center'">国别</th>
                <th data-options="field:'language',width:'10%',align:'center'">语言</th>
		 ...
		 <c:forEach items="${pagingTool.dataSet}" var="textConData">
				...
				<td>
                <a href="#" onclick="loadCatalogPage(${textConData.id})">内容管理</a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="#" onclick="edit(${textConData.id},'${textConData.author}','${textConData.name}')">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;
