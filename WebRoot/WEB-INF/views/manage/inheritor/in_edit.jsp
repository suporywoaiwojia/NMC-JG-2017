...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			if('${in.approve_id}'!='')
				$('#approve_id').combobox('select','${in.approve_id}-${in.approve_name}');
			if('${in.sex}'!='')
	...
	<body>
		 <div class="easyui-panel"   style="width:100%;padding:15px">
		  <div style="padding:0 0 10px;">
			...
			<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-exp'" style="width:10%;" onclick="exppdf('${in.id}')">导出</a>	
		  ...
		  <form method="post" id="inheritor">
			...
			<table class="data">
				...
				<tr>
					...
					<td><a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="open_log('${in.id}','2')">查看日志</a></td>
				</tr>
				</c:if>
			  <tr>
			  ...
			  <tr>
				...
				<td>
				<input name="born_s" id="born_s" class="easyui-datebox" style="width:140px" data-options="sharedCalendar:'#cc',formatter:myformatter,parser:myparser,editable:false,required:true,missingMessage:'出生日期不能为空'" value="${in.born_s}" />至
			  ...
			  <tr>
				...
				<td>
					 <select class="easyui-combobox" style="width:300px;height:30px; text-align:left;" name="project.id" id="project" data-options="editable:false">
...
<!--申报文本上传 -->
	...
	<script type="text/javascript">
		function save(state){
			var url = "${basePath}action/inheritor/update/"+state;
		...
		function exppdf(ids){
			var url="${basePath}action/inheritor/exp/"+ids;
	...
	<div id="dlg" class="easyui-dialog" title="导出" closed="true" data-options="iconCls:'icon-exp'" style="width:260px;height:140px;padding:10px; line-height:80px;text-align:center">
		<a href="#" download="传承人信息-${in.name}.pdf" target="_blank" id="download">下载</a>
	</div>
	<script type="text/javascript">
	//upload传递变量
