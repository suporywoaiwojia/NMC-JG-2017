...
<div class="easyui-panel"   style="width:100%;padding:15px">
  <div  style="padding:0 0 10px;" >
    <a id="save" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save'" style="width:100px;" >保存</a>	   
  </div>       
  ...
  <form id="web-form" action="" method="post">
    <table align="center" id="imagesTable" >
      <tr>
               ...
               <td></td>
        <td>幻灯名称</td>
        <td style="padding-left:10px;"><input id="name"  name="name"  data-options="required:true,validType:'length[0,10]',missingMessage:'幻灯名称不能为空',invalidMessage:'长度不能超出10个字符'" class="easyui-textbox" style="width:300px;height:30px;"/></td> 
		<td>
        </td>
        <td >
   ...
   function initUpLoad(NUM){
       ...
       var $wrap = $('#uploader_'+NUM),
        ...
        uploader = WebUploader.create({
            ...
            formData: {
                uid: 123,
				httpPath:'${basePath}website/upload_file/slideshow/',
