		...
		$(function(){
			var _MESSAGE = '${message}'; 
				...
				*/
				...
				$("#query").click(function(){
					...
					$("#contentForm").attr("action","${basePath}/action/contentcheck/list/0/"+columnId+"/"+encodeURI(encodeURI(columnName))+"/"+columnType);
					$("#contentForm").submit();
				});
			...
			*/
			function gotoPage(currentPage,totalPage){
				...
				$("#contentForm").attr("action","${basePath}/action/contentcheck/list/"+currentPage+"/"+columnId+"/"+encodeURI(encodeURI(columnName))+"/"+columnType);
			...
			function edit_content(ids){
				...
				$("#contentForm").attr("action","${basePath}/action/contentcheck/docheck/"+ids);
				$("#contentForm").submit();
			}
			...
			function del_content(ids){
				...
				art.dialog.confirm("您确定要删除吗？",function (){
					$("#contentForm").attr("action","${basePath}/action/content/deleteMember/"+ids+"/"+$("#currentPage").text());
	    		...
	    		<tr>
	    			<td align="center" valign="middle">
						...
						<ul>
							...
							<li class="buttonBox">
							<input type="button" id="query" class="selectButtonBG" title="查询"/>
							</li>
						</ul>
	    			</td>
				...
				<c:when test="${status.index % 2 == 0}">  
       			...
       			<c:otherwise>  
          		  <tr  class="contentTR2">  
				 	...
				 	<td align="center" valign="middle" >
					<input type="checkbox" id="checkbox" name="checkbox" value="${content.id}" class="styled"/>
					</td>
	    			<td align="center" valign="middle" >
	    				${content.column.name}
	    			</td>
	    			...
	    			<td   align="center" valign="middle">
	    				...
	    				&nbsp;&nbsp;
	    				<a onclick="edit_content('${content.id}')"><img src="${basePath}style/images/edit.png" alt="审核" title="审核" /></a>
