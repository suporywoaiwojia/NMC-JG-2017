...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(function(){
			...
			files_img.each(function(){
				...
				//附件
				if($("#columnType").val()=='3'||$("#columnType").val()=='4'||$("#columnType").val()=='7'){
		...
		function check(){
			...
			$(function(){
				...
				$("#save").click(function(){
					...
					if(flag){
						<c:choose>  
							...
							$("#contentEdit").attr("action","${basePath}/action/contentcheck/update");
				...
				$("#openTree").click(function(){
					window.open("${basePath}/action/contentcheck/columnTree");
				});
				$("#back").click(function(){
					$("#contentEdit").attr("action","${basePath}/action/contentcheck/goback");
					$("#contentEdit").submit();
				});
			});
	...
	<form  name="contentEdit" id="contentEdit" method="post">
		    ...
		    <table style="width:100%;min-width:800px;margin:0 auto;border:0px solid #ccc;" align="center" cellpadding="0" cellspacing="0" border="0">
		    	<tr>
					...
					<ul class="newShortBoxInput">
						...
						<input type="text" name="title" id="title" class="newInput"  value="${content.title}" maxlength="150"/>
						</li>
					</ul>
					...
					<ul class="newShortBoxInput">
							...
							<li class="newShortBoxinput">
						<input type="text" name="dayTop" id="dayTop"   value="${dayTop}" readonly="readonly"/>
						</li>
					</ul>
					<ul class="newShortBoxInput">
							<li class="newBoxleftTitle">周点击量</li>
							<li class="newShortBoxinput">
						<input type="text" name="weekTop" id="weekTop"  value="${weekTop}" readonly="readonly"/>
						</li>
					</ul>
					<ul class="newShortBoxInput">
							<li class="newBoxleftTitle">月点击量</li>
							<li class="newShortBoxinput">
						<input type="text" name="monthTop" id="monthTop"  value="${monthTop}" readonly="readonly"/>
						</li>
					</ul>
					<ul class="newShortBoxInput">
							<li class="newBoxleftTitle">总点击量</li>
							<li class="newShortBoxinput">
						<input type="text" name="hitTop" id="hitTop" value="${hitTop}" readonly="readonly"/>
						</li>
					</ul>
					</td>
		    	</tr>
		    	...
		    	<tr >
			    		...
			    		<td  class="titleFormBox" valign="middle">
			    			...
			    			<div class="labelClass" id="addtag" onclick="showAllLabel();">
							</div>
		    		</td>
		    	</tr>
    	  </table>	
		 ...
		 " </div>";
			...
			<table style="width:100%;min-width:800px;margin:0 auto;border:0px solid #ccc;" align="center" cellpadding="0" cellspacing="0" border="0" id="type5" >	
				...
				<table style="width:100%;min-width:800px;margin:0 auto;border:0px solid #ccc;" align="center" cellpadding="0" cellspacing="0" border="0"  id="type4">
		    		<tr>
			    	    <td ><input type="button" id="addRows" value="添加图片" class="publichButton"/><p></p>&nbsp;</td>
					</tr>
					<tr>
			    		<td  id="imgList">
			    		...
			    		<td>
							...
							<ul class="newlongInput">
								...
								<li class="newBoxinput">
					    			...
					    			<input type="hidden" id="attachmentfilePath" name="attachmentfilePath"  value="${contentFile.filePath}" />		<input type="hidden" name="attachmentsavePath" id="attachmentsavePath" value="${contentFile.savePath}"/>
					    		</li>
							</ul>
							<ul class="newShortInput">
								<li class="newBoxleftTitle">可下载</li>
					    			...
					    			<li class="newBoxinput">
					    			<input type="checkbox" name="checkbox" id="checkbox" onclick="downLoad_Check(this);"  class="styled" <c:if test="${contentFile.download eq '1'}"> checked="checked"</c:if>  /><input type="hidden" name="attachmentDownload"   id="attachmentDownload" value="${contentFile.download}"/>
								</li>
							</ul>
							<c:if test="${content.column.columnType eq 7}">
							<ul class="newShortInput">
							...
							<ul class="newlongInput">
								<li class="newBoxleftTitle">价格</li>
					    		<li class="newBoxinput">
									<input type="text" name="price" id="price" value="${contentFile.price}"  />
					    			<!--<input type="button"  value="删除"  onclick="$(this).parent().parent().remove()"  class="buttonBG"/> -->
				    			</li>
				    		</ul>
							</label>
		...
		<script type="text/javascript">
			...
			//视频
			if($("#columnType").val()=='4'||$("#columnType").val()=='7'){
