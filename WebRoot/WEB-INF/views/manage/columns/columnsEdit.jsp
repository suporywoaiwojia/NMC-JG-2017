	 	...
	 	<div class="easyui-panel"   style="width:100%;padding:15px; height:700px">
			...
			<table  class="data">
			  <tr>
			   ...
			   <tr>
				<td>项目编码</td>
				<td><input class="easyui-textbox" style="width:300px;height:30px" name="no" id="no" value="${column.no}" data-options="required:true,validType:'length[0,10]',missingMessage:'项目编码不能为空',invalidMessage:'长度不能超出10个字符'"></td>
				<td>附件地址</td>
				<td><input class="easyui-textbox" style="width:300px;height:30px" name="conFilesSavPath" id="conFilesSavPath" value="${column.conFilesSavPath}" data-options="required:false,validType:'length[0,100]',invalidMessage:'长度不能超出100个字符'"></td>
			  </tr>
			  <tr>
				<td>项目排序</td>
