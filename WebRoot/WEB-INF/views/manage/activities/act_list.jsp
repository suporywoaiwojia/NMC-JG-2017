...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function pageRefresh(page){
			var url="${basePath}action/act/list/CN/"+page;
		...
		//跳转新建页面
		function newpage(){
			window.parent.topage('专项活动内容','act/newpage');
		}
		//跳转编辑页面
		function edit(ids){
			window.parent.topage('专项活动内容','act/editpage/'+ids);
		}
		//删除全部
		function delall(){
		...
		function deldata(ids){
			var url="${basePath}action/act/del/"+ids;
		...
		<div style="width:100%;height:700px;">
	      ...
	      <table id="dg" title="查询结果" style="width:100%;height:560px"   class="easyui-datagrid"  data-options="
			...
			<tr>
				...
				<td><a href="#" onclick="edit('${act.id}')">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="del('${act.id}')">删除</a></td>
			</tr>
			</c:forEach>
		</tbody>
	      </table>
