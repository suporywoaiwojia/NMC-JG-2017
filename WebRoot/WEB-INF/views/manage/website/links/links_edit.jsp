...
=======
			<input type="hidden" id="filePath" name="filePath" value="${link.filePath}"/>		</td>
        <td>链接名称:</td>
        <td><input id="name"  name="name" value="${link.name}" data-options="required:true,validType:'length[0,10]',missingMessage:'链接名称不能为空',invalidMessage:'长度不能超过10个字符'" class="easyui-textbox" style="width:300px;height:30px"/></td>        
      </tr>
>>>>>>> .r165
	  <tr >
	    <td>链接地址</td>
	    <td><input id="link" name="link" value="${link.link}" data-options="required:true,validType:'length[0,100]',missingMessage:'链接地址不能为空',invalidMessage:'长度不能超过100个字符'" class="easyui-textbox" style="width:300px;height:30px"/></td>
	    </tr>
	  <tr >
	  	<td>链接描述:</td>
        <td><input id="detailed" name="detailed" value="${link.detailed}" class="easyui-textbox" data-options="multiline:true,required:false,validType:'length[0,150]',invalidMessage:'长度不能超过150个字符'" style="width:300px;height:100px"/></td>
      </tr>
    </table>
    </form>
  </div>      
