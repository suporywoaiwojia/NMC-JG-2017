...
<div class="common-pagination">
	[#if listDynamics==1]
		[#if (currentPage>1)]
			<a href="list_${currentPage-1}${pageFormat}" class="enable"><span>上一页</span></a>
		[#else]
		...
		[#if (currentPage<totalPages)]
			<a href="list_${currentPage+1}${pageFormat}"  class="enable"><span>下一页</span></a>
		[#else]
	...
	[#else]
		...
		[#if (currentPage>1)]
    		<a href="${currentPage-1}" class="enable"><span>上一页</span></a>
		[#else]
			<a class="disable"><span>上一页</span></a>
		[/#if]   
		[#if (totalPages<9)]	[#--总页数小于9的情况每页都显示--]
		...
		[#if (currentPage<totalPages)]
			<a href="${currentPage+1}"  class="enable"><span>下一页</span></a>
		[#else]
			<a class="disable"><span>下一页</span></a>
		[/#if]
	[/#if]  
